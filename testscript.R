...
scenarioArray <- array(dim = c(1200, 4, 1))
MSAT_levels <- c(5, 10, 15, 20, 25)
# QUAC_array_list = list(1:30)
...
# MSATscenariosList[] <- readRDS(MSATscenarios[2])




# iterating manually
QUAC_array_list <- gm_resamp_array_function(MSATscenariosList[[1]],5,5)
QUAC_array_list <- gm_resamp_array_function(MSATscenariosList[[2]],5,5)

test <- abind(supremeArray[])
supremeArray[,,1] <- QUAC_array_list[1]
